    ...
    $.fn.pagepiling = function (custom) {
        ...
        */
        function addMouseWheelHandler(){
            ...
            if (container.get(0).addEventListener) {
                container.get(0).addEventListener('mousewheel', MouseWheelHandler, supportsPassive ? {passive: true} : false); //IE9, Chrome, Safari, Oper
                container.get(0).addEventListener('wheel', MouseWheelHandler, supportsPassive ? {passive: true} : false); //Firefox
            } else {
